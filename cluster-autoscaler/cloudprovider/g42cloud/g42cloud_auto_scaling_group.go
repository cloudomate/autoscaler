...
// AutoScalingGroup represents a g42cloud's 'Auto Scaling Group' which also can be treated as a node group.
...
func newAutoScalingGroup(csm CloudServiceManager, sg g42cloudsdkasmodel.ScalingGroups) AutoScalingGroup {
